...
function editar(numero){
    ...
    if (numfila <= 1) {
        ...
        document.body.getElementsByClassName('div1')[0].textContent = 'Presione Aceptar para actualizar la tabla. Cancelar para rellenar el formulario desde cero.';
        ...
        alert("Por favor, edite una linea.");
    }
}